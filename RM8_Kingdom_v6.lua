...
-- طباعة الحقوق الرسمية بالكامل باللغة العربية والرموز
print("--------------------------------------------------")
print("المطور القثردي🇸🇦 /المبرمج ابو حديده🗞")
print("--------------------------------------------------")

-- مصفوفة البيانات المشفرة لـ URL النسخة السادسة
local _0xPayload = {
    ...
    82, 77, 56, 95, 75, 105, 110, 103, 100, 111, 109, 95, 118, 54, 46, 108, 117, 97
}
